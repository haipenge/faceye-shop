			...
			<div class="content">
				...
				<div classs="table-responsive">
					<table class="table table-bordered">
						...
						<tbody>
							<c:forEach items="${page.content}" var="inventory">
								<tr id="${inventory.id}">
									<td><input type="checkbox" name="check-single" value="${inventory.id}"></td>
									...
									<td><a href="<c:url value="/inventory/inventory/detail/${inventory.id}.html"/>"><fmt:message key="global.view"/></a></td>
									<td><a
										href="<c:url value="/inventory/inventory/edit/${inventory.id}"/>"> <fmt:message
												key="global.edit"></fmt:message>
									</a></td>
									<td><a
										href="<c:url value="/inventory/inventory/remove/${inventory.id}"/>"> <fmt:message
