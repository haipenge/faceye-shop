...
<div class="cl-mcont">
	...
	<c:import url="/component/core/template/msg/msg.jsp" />
		<div class="content">
			<form action="<c:url value="/platform/platform/home"/>" method="post" role="form"
...
<div class="col-md-1">
	<input type="text" name="EQ|name" value="${searchParams.name}"
		placeholder="<fmt:message key="platform.platform.name"></fmt:message>"
...
<!--@generate-entity-jsp-query-detail@-->
 ...
 <!--@generate-entity-jsp-property-value@-->
								<td><a href="<c:url value="/platform/platform/detail/${platform.id}"/>">
										<fmt:message key="global.view"></fmt:message>
								</a></td>
								<td><a href="<c:url value="/platform/platform/edit/${platform.id}"/>">
										<fmt:message key="global.edit"></fmt:message>
								</a></td>
								<td><a href="<c:url value="/platform/platform/remove/${platform.id}"/>">
