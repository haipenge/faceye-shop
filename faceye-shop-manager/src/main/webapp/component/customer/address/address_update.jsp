...
<div class="block-flat">
	...
	<form:form action="/customer/address/save" method="post" role="form" cssClass="form-horizontal" commandName="address">
			...
			<fieldset>
				...
				<div class="form-group">
	<label class="col-md-2 control-label" for="mobile"> <spring:message
...
<div class="form-group">
	<label class="col-md-2 control-label" for="province"> <spring:message
			code="customer.address.province"/>
	</label>
	<div class="col-md-6">
...
<div class="form-group">
	<label class="col-md-2 control-label" for="area"> <spring:message
			code="customer.address.area"/>
	</label>
	<div class="col-md-6">
...
<div class="form-group">
	<label class="col-md-2 control-label" for="street"> <spring:message
			code="customer.address.street"/>
	</label>
	<div class="col-md-6">
...
<div class="form-group">
	<label class="col-md-2 control-label" for="detail"> <spring:message
			code="customer.address.detail"/>
	</label>
	<div class="col-md-6">
...
<div class="form-group">
	<label class="col-md-2 control-label" for="isDefault"> <spring:message
			code="customer.address.isDefault"/>
	</label>
	<div class="col-md-6">
