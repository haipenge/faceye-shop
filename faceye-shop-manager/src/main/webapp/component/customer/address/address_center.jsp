...
<div class="page-head">
	<h2>
		...
		<a class="btn btn-primary" href="<c:url value="/customer/address/input"/>"> <fmt:message
				key="customer.address.add"></fmt:message>
		</a>
	</h2>
</div>
<div class="cl-mcont">
	<div class="block-flat">
		<div class="content">
			<form action="<c:url value="/customer/address/home"/>" method="post" role="form" class="form-horizontal">
				<fieldset>
					<div class="form-group">
						...
						<div class="col-md-1">
							<input type="text" name="EQ|mobile" value="${searchParams.mobile}"
								placeholder="<fmt:message key="customer.address.mobile"></fmt:message>" class="form-control input-sm">
						</div>

						<div class="col-md-1">
							<input type="text" name="EQ|receiveUserName" value="${searchParams.receiveUserName}"
								placeholder="<fmt:message key="customer.address.receiveUserName"></fmt:message>" class="form-control input-sm">
						</div>

						<div class="col-md-1">
							<input type="text" name="EQ|province" value="${searchParams.province}"
								placeholder="<fmt:message key="customer.address.province"></fmt:message>" class="form-control input-sm">
						</div>

						<div class="col-md-1">
							<input type="text" name="EQ|city" value="${searchParams.city}"
								placeholder="<fmt:message key="customer.address.city"></fmt:message>" class="form-control input-sm">
						</div>

						<div class="col-md-1">
							<input type="text" name="EQ|area" value="${searchParams.area}"
								placeholder="<fmt:message key="customer.address.area"></fmt:message>" class="form-control input-sm">
						</div>

						<div class="col-md-1">
							<input type="text" name="EQ|street" value="${searchParams.street}"
								placeholder="<fmt:message key="customer.address.street"></fmt:message>" class="form-control input-sm">
						</div>

						<div class="col-md-1">
							<input type="text" name="EQ|detail" value="${searchParams.detail}"
								placeholder="<fmt:message key="customer.address.detail"></fmt:message>" class="form-control input-sm">
						</div>

						<div class="col-md-1">
							<input type="text" name="EQ|isDefault" value="${searchParams.isDefault}"
								placeholder="<fmt:message key="customer.address.isDefault"></fmt:message>" class="form-control input-sm">
						</div>

						<div class="col-md-1">
							<input type="text" name="EQ|isRemoved" value="${searchParams.isRemoved}"
								placeholder="<fmt:message key="customer.address.isRemoved"></fmt:message>" class="form-control input-sm">
						</div>
					...
					<tbody>
						<c:forEach items="${page.content}" var="address">
							<tr id="${address.id}">
								...
								<td><f:boolean value="${address.isDefault}" /></td>
								<td><f:boolean value="${address.isRemoved}" /></td>
