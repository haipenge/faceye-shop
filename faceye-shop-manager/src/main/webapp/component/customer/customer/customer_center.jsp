...
<div class="page-head">
	<h2>
		...
		<a class="btn btn-primary" href="<c:url value="/customer/customer/input"/>"> <fmt:message
					...
					<div class="form-group">
						<div class="col-md-2">
							<input type="text" name="EQ|name" value="${searchParams.name}"
								placeholder="<fmt:message key="customer.customer.name"></fmt:message>" class="form-control input-sm">
						</div>
						<div class="col-md-2">
							<input type="text" name="EQ|mobile" value="${searchParams.mobile}"
								placeholder="<fmt:message key="customer.customer.mobile"></fmt:message>" class="form-control input-sm">
						</div>

						<div class="col-md-1">
							<input type="text" name="EQ|uid" value="${searchParams.uid}"
								placeholder="<fmt:message key="customer.customer.uid"></fmt:message>" class="form-control input-sm">
						</div>
					...
					<tbody>
						<c:forEach items="${page.content}" var="customer">
							<tr id="${customer.id}">
								...
								<td><a href="<c:url value="/customer/customer/detail/${customer.id}"/>"><fmt:message key="global.view"/></a>
								<td><a href="<c:url value="/customer/customer/edit/${customer.id}"/>"> <fmt:message key="global.edit"></fmt:message>
								</a></td>
								<td><a href="<c:url value="/customer/customer/remove/${customer.id}"/>"> <fmt:message
