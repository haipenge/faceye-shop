	...
	<div class="header">
		<h3>
			<c:choose>
				...
				<c:otherwise>
					<fmt:message key="inventory.item.edit"></fmt:message>
				</c:otherwise>
			</c:choose>
		</h3>
	</div>
	...
	<form:form action="/inventory/invoiceItem/save" method="post" role="form" cssClass="form-horizontal" commandName="invoiceItem">
			...
			<fieldset>
				<div class="form-group">
					<label class="col-md-2 control-label" for="name"> <spring:message code="inventory.item.shop"/>
					</label>
					<div class="col-md-6">
				...
				<div class="form-group">
					<label class="col-md-2 control-label" for="name"> <spring:message code="inventory.item.product"/>
					</label>
					<div class="col-md-6">
				...
				<div class="form-group">
					<label class="col-md-2 control-label" for="name"> <spring:message code="inventory.item.productSku"/>
					</label>
					<div class="col-md-6">
				...
				<div class="form-group">
					<label class="col-md-2 control-label" for="name"> <spring:message code="inventory.item.quantity"/>
					</label>
					<div class="col-md-6">
				...
				<div class="form-group">
					<label class="col-md-2 control-label" for="name"> <spring:message code="inventory.item.invoice"/>
					</label>
					<div class="col-md-6">
