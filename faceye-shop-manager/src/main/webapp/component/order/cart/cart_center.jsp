...
<div class="page-head">
	<h2>
		...
		<a class="btn btn-primary" href="<c:url value="/order/cart/input"/>"> <fmt:message
				key="order.cart.add"></fmt:message>
		</a>
	</h2>
</div>
<div class="cl-mcont">
	...
	<div class="block-flat">
		<div class="content">
			<form action="<c:url value="/order/cart/home"/>" method="post" role="form"
...
<div class="col-md-1">
	<input type="text" name="EQ|uid" value="${searchParams.uid}"
		placeholder="<fmt:message key="order.cart.uid"></fmt:message>"
...
<!--@generate-entity-jsp-query-detail@-->
 ...
 <!--@generate-entity-jsp-property-value@-->
								<td><a href="<c:url value="/order/cart/edit/${cart.id}"/>">
										<fmt:message key="global.edit"></fmt:message>
								</a></td>
								<td><a href="<c:url value="/order/cart/remove/${cart.id}"/>">
