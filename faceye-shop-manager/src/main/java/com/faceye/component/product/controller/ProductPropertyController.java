...
public class ProductPropertyController extends BaseShopController<ProductProperty, Long, ProductPropertyService> {
	@Autowired
	...
	public String home(HttpServletRequest request, Model model) {
		...
		return "product.productProperty.manager";
	}
	...
	public String edit(@PathVariable("id") Long id,Model model,HttpServletRequest request) {
		if(id!=null){
			beforeInput(model,request);
			ProductProperty entity=this.service.get(id);
			model.addAttribute("productProperty", entity);
		}
	...
	public String save(@Valid ProductProperty productProperty,BindingResult bindingResult,Model model,HttpServletRequest request, RedirectAttributes redirectAttributes) {
		if(bindingResult.hasErrors()){
		  ...
		  return "redirect:/product/productProperty/home";
		}
	}
	...
	public String detail(@PathVariable Long id,Model model){
		...
		return "product.productProperty.detail";
	}
