...
public abstract class BaseShopController<T, ID extends Serializable, S extends BaseService<T, ID>> {
	...
	@Autowired
	protected DynamicPropertyService dynamicPropertyService = null;
	@Autowired
	protected ProductSkuService productSkuService = null;
	@Autowired
	protected SkuPropertyService skuPropertyService = null;
	@Autowired
