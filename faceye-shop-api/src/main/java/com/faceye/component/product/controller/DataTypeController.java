...
public class DataTypeController extends BaseController<DataType, Long, DataTypeService> {
	...
	@RequestMapping("/home")
	@ResponseBody
	public Page<DataType> home(HttpServletRequest request, Model model) {
	...
	@ResponseBody
	public DataType detail(@PathVariable Long id,Model model){
		if(id!=null){
			DataType dataType=this.service.get(id);
		}
		return dataType;
	}
