...
public class DynamicPropertyController extends BaseController<DynamicProperty, Long, DynamicPropertyService> {
	@Autowired
	...
	@RequestMapping("/home")
	@ResponseBody
	public Page<DynamicProperty> home(HttpServletRequest request, Model model) {
	...
	@ResponseBody
	public DynamicProperty edit(@PathVariable("id") Long id,Model model,HttpServletRequest request) {
		beforeInput(model,request);
	...
	@RequestMapping("/save")
	@ResponseBody
	public String save(@Valid DynamicProperty dynamicProperty,BindingResult bindingResult,Model model,HttpServletRequest request, RedirectAttributes redirectAttributes) {
	...
	@ResponseBody
	public DynamicProperty detail(@PathVariable Long id,Model model){
		DynamicProperty dynamicProperty=this.service.get(id);
		return dynamicProperty;
	}
