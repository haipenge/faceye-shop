...
public class CartController extends BaseController<Cart, Long, CartService> {
	...
	@RequestMapping("/home")
	@ResponseBody
	public Page<Cart> home(HttpServletRequest request, Model model) {
	...
	@ResponseBody
	public Cart detail(@PathVariable Long id,Model model){
		if(id!=null){
			Cart cart=this.service.get(id);
		}
		return cart;
	}
