...
<div class="block-flat">
	...
	<div class="content">
	<form:form action="/product/product/save" method="post" role="form" cssClass="form-horizontal" commandName="product">
			<form:hidden path="id"/>
			<fieldset>
				...
				<div class="form-group">
					<label class="col-md-2 control-label" for="name"> <spring:message code="product.product.code"/>
					</label>
					<div class="col-md-6">
				...
				<div class="form-group">
					<label class="col-md-2 control-label" for="name"> <spring:message code="product.product.shop"/>
					</label>
					<div class="col-md-6">
				...
				<div class="form-group">
	<label class="col-md-2 control-label" for="isOnSale"> <spring:message
			code="product.product.isOnSale"/>
	</label>
	<div class="col-md-6">
		<form:input path="isOnSale" cssClass="form-control"/>
		<form:errors path="isOnSale" cssClass="error"/>
	</div>
</div>
