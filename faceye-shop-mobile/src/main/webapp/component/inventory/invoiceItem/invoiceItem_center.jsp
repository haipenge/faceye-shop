<%@ include file="/component/core/taglib/taglib.jsp"%>
	<link rel="stylesheet" type="text/css"
		href="<c:url value="/css/component/inventory/invoiceItem/invoiceItem.css"/>" />
	<script type="text/javascript"
		src="<c:url value="/js/component/inventory/invoiceItem/invoiceItem.js"/>"></script>
	<div class="page-head">
		<h2>
			<fmt:message key="inventory.invoiceItem.manager"></fmt:message>
			<a class="btn btn-primary" href="<c:url value="/inventory/invoiceItem/input"/>">
						...
						<div class="form-group">
							...
							<div class="col-md-2">
								<input type="text" name="EQ|quantity" value="${searchParams.quantity}"
									placeholder="<fmt:message key="inventory.invoiceItem.quantity"></fmt:message>"
			...
			<div class="content">
				...
				<div classs="table-responsive">
					<table class="table table-bordered">
						<thead>
							<tr>
								<th><input type="checkbox" name="check-all"></th>
								  <th><fmt:message key='inventory.invoiceItem.shop'></fmt:message></th>
								  <th><fmt:message key='inventory.invoiceItem.product'></fmt:message></th>
								  <th><fmt:message key='inventory.invoiceItem.productSku'></fmt:message></th>
								  <th><fmt:message key='inventory.invoiceItem.quantity'></fmt:message></th>
								  <th><fmt:message key='inventory.invoiceItem.invoice'></fmt:message></th>
						...
						<tbody>
							<c:forEach items="${page.content}" var="invoiceItem">
								<tr id="${invoiceItem.id}">
									<td><input type="checkbox" name="check-single" value="${invoiceItem.id}"></td>
									...
									<td><a href="<c:url value="/inventory/invoiceItem/detail/${invoiceItem.id}.html"/>"><fmt:message key="global.view"/></a></td>
									<td><a
										href="<c:url value="/inventory/invoiceItem/edit/${invoiceItem.id}"/>"> <fmt:message
												key="global.edit"></fmt:message>
									</a></td>
									<td><a
										href="<c:url value="/inventory/invoiceItem/remove/${invoiceItem.id}"/>"> <fmt:message
