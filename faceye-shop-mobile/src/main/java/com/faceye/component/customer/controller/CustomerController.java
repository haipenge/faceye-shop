...
public class CustomerController extends BaseShopController<Customer, Long, CustomerService> {
	@Autowired
	private com.faceye.component.security.web.service.UserService userService = null;
	@Autowired
	...
	public String me(Model model) {
		...
		if (user != null) {
			WeixinUser weixinUser = this.weixinUserService.getWeixinUserByOpenid(user.getWeixinOpenId());
