...
/**
 * 模块:产品->product->ProductSku<br>
 * 说明:<br>
 * 实体:产品SKU->com.faceye.component.product.entity.ProductSku Mongo 对像<br>
 * mongo数据集:product_productSku<br>
 * @author haipenge <br>
...
@Document(collection="product_product_sku")
