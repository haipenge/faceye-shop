...
/**
 * 模块:产品->product->ProductProperty<br>
 * 说明:<br>
 * 实体:产品属性->com.faceye.component.product.entity.ProductProperty Mongo 对像<br>
 * mongo数据集:product_productProperty<br>
 * @author haipenge <br>
...
@Document(collection="product_product_property")
