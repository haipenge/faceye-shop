...
/**
 * 模块:库存->inventory->Inventory<br>
 * 说明:<br>
 * 实体:库存明细->com.faceye.component.inventory.entity.Inventory Mongo 对像<br>
 * mongo数据集:inventory_inventory<br>
 * @author haipenge <br>
...
@Document(collection="inventory_inventory")
